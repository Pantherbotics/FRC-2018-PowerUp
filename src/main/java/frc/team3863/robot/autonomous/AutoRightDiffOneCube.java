...
public class AutoRightDiffOneCube extends PathedAutonomous {

    public AutoRightDiffOneCube() {
        // Add Commands here:
        ...
        addParallel(new ElevatorSetpoint(5, 4));
        addSequential(new AutoPathFollower(Robot.paths.get("rightDiffSideScale1")));
